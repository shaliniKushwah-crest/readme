The CyCognito Feed integration will retrieve the discovered assets from the CyCognito platform based on user-specified filters. A comprehensive dashboard and layout are also included.
...
3. Click **Add instance** to create and configure a new integration instance.
    ...
    | Security Rating | Filters the assets according to security rating.<br/><br/>Supported values:<br/>A: Very strong,<br/>B: Strong,<br/>C: Less vulnerable,<br/>D: Vulnerable,<br/>F: Highly vulnerable<br/><br/>Note: This filter does not support IP Range asset type. | False |
...
| security_rating | Filters the assets according to security rating. Supports comma-separated values.<br/><br/>Supported values: 'A', 'B', 'C', 'D', 'F'<br/><br/>Where:<br/>A = Very strong<br/>B = Strong<br/>C = Less vulnerable<br/>D = Vulnerable<br/>F = Highly vulnerable<br/><br/>Note: This filter does not support IP Range asset type. | Optional | 
...
| locations | The geographical locations in which the asset is found. Supported values contain the three-letter ISO country code for the respective countries--e.g., IND, USA. | Optional | 
